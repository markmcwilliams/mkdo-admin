...
class MKDO_Admin {
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-mkdo-admin-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-mkdo-admin-i18n.php';

		/**
		 * The classes responsible for defining all actions that occur in the Dashboard.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-mkdo-admin-admin.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-mkdo-admin-bar.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-mkdo-admin-footer.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-mkdo-admin-dashboard.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-mkdo-admin-menus.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-mkdo-admin-notices.php';

		/**
		 * The classes responsible for defining all actions that occur in user profiles.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-mkdo-admin-profile.php';

		/**
		 * The classes responsible for defining all the custom post types.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-mkdo-admin-cpt-posts.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-mkdo-admin-cpt-pages.php';

		/**
		 * The classes responsible for defining all the custom metaboxes.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-mkdo-admin-metaboxes.php';
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-mkdo-admin-public.php';

		$this->loader = new MKDO_Admin_Loader();
	}
	...
	private function set_locale() {
		...
		$plugin_i18n = new MKDO_Admin_i18n();
		$plugin_i18n->set_domain( $this->get_mkdo_admin() );
	...
	private function define_admin_hooks() {
		 ...
		 */
		$plugin_admin 			= new MKDO_Admin_Admin						( $this->get_mkdo_admin(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		// $plugin_public = new MKDO_Admin_Public( $this->get_mkdo_admin(), $this->get_version() );
	 ...
	 */
	public function get_mkdo_admin() {
		return $this->mkdo_admin;
	}
